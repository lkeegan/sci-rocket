...
def test_output_consistent_between_one_run_and_two_runs(field: str):
    """This test requires that the ci/test_bcl_one_run and ci/test_fastq_from_bcl_two_runs workflows have been run."""
    reference_data = load_scidash_data("bcl_one_run")
    this_data = load_scidash_data("fastq_from_bcl_two_runs")
